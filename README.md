...
8. Create an Item in Firestore in the collection Items. It should look like this: ![github-small](https://github.com/comhendrik/ShopApp/explanationImage.png) Please upload an product image to Storage and the variable imagePath should contain the matching URL from FirebaseStorage.
